...
<li><strong>How did your experience of designing and producing a three-dimensional environment differ from your experience of designing and producing a project in two-dimensional media?</strong></li>
<li>The experience of creating an interactive, 3D environment was incredibly different to that of creating a two-dimensional piece of media. When in the first design stages of creating this media, there is a lot more aspects to account for and imagine when designing. In my experiences of creating 2D media, the main things I needed to account for when designing is how the user with view the media and what feelings will be conveyed to them upon viewing, because 2D has a lot less environmental space to work with, it requires less intricate detailing then 3D. When it came to designing my 3D environment, I had to account for all spatial aspects of the area, I wanted the player to be able to move in a 3D space, jumping up and down while moving forward, backwards and side to side. I also needed to account for visuals in all directions, every direction the user looked in, the environment needed to look deliberate and meaningful.</li>
<li><strong>What was the role of the virtual camera in your project, and how was it similar to and different from the role of the camera in Assignment 1?</strong></li>
<li>The role of the virtual camera in my project was to take on the view of the player, I knew a large majority of projects in this assignment would have the camera as just a movable player, while lacking a possible interaction system, I decided to take this advantage and create an in-depth interaction system for my virtual camera/player. Creating the ability to; talk to characters, open/close doors, pick up items that go into an inventory and read notes that were scattered around the map. The role of the virtual camera in this environment was not only to experience what was surrounding them, but also to interact with it, and possibly deeper immerse the player into the 3D environment. The role of the camera from my first assignment has two deep aspects to it. On one hand, the role of the camera in each scene was to capture memories, to record pivotal moments throughout my life, allowing myself to look back on them and reminisce, on the other hand, the role of the camera was to present visual media to the viewer, to entertain them and invoke deliberate feelings towards the viewer.</li>
<li><strong>How did you use sound in your project, and how was this similar to and different from your use of sound in Assignments 1 and 2?</strong></li>
<li>Sound was a major aspect of my 3D environment project, it’s role was to create an immersive experience for the user, and create a strong structural base for each scene. I used different SFX in each scene, ranging from; upbeat music, forest ambience, uneasy music, dialogue SFX, flickering lights SFX and other SFX for interaction systems. This was similar to my uses of sound in Assignments 1 & 2 as sound in each assignment was a key aspect for conveying a core theme to the user/viewer, and create a purposeful experience for them. The sound in Assignments 1 & 3 were very similar as they were intended to be a foundation for the visuals of the media, and structurally lift the viewing experience, whereas in the 2nd Assignment, the sound was intended to accompany the visual icons and were just as important to the overall experience as the visuals were.</li>
<li><strong>How did you unify the different elements of your virtual environment under a certain theme or concept? How did your theme or concept evolve over the project’s development?</strong></li>
<li>In the first designs of my environment I had unified the theme under a ‘low poly’ style environment and had stuck by this by using similar style objects and textures. My concept originally was not to create such an in-depth, interactive environment, but just to create a ‘walking-simulator’ style environment, in which the user just walks through a set environment, experiencing events around them. When I had lost my original project to the file becoming corrupted, I used this setback as a means of changing my theme and concept for the project. I decided to shift from the ‘low-poly’ style game to a retro inspired ‘PSX’ themed video game, with low graphics and janky physics.</li>
<li><strong>What did you discover through the process of play testing that you wouldn’t have discovered otherwise?</li>
<li> The process of having an outsider individual to playtest my 3D environment was very effective for me understanding how to elevate my project to the next level. I had gotten my partner to playtest my environment for me, this was done intentionally as she had little to no experience with video games, this meant I would be getting the interaction from what an average person is seeing and experiencing, this helped to see if my guides were strong enough for the player and if systems of interaction were obvious enough and not overlooked.</li>